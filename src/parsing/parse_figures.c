...
/*   Updated: 2026/01/09 14:12:40 by vramacha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_obj	*parse_sphere(char *line)
{
	...
	init_vector(obj->sp.mt.pattern.param, 0.7071, 0.7071, 0);
	obj->sp.mt.pattern.fcn = stripped_pattern;
...
t_obj	*parse_plane(char *line)
{
	...
	init_vector(obj->pl.mt.pattern.param, 1, 1, 1);
