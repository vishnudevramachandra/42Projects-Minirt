...
/*   Updated: 2026/01/29 10:51:16 by vramacha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../Includes/minirt.h"

static void	translate_objects_helper(t_obj *obj, mat4 mat)
{
	if (obj->typ == SPHERE)
...
static void	translate_objects(t_list *node, mat4 mat)
{
	t_obj	*obj;
...
static void	translate_lights(t_list *node, mat4 mat)
{
	t_light	*light;
